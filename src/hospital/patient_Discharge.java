    ...
    patient_Discharge(){
        ...
        discharge.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                conn c = new conn();
                try {
                    c.statement.executeUpdate("delete from patients where Number = '"+choice.getSelectedItem()+"'");
        ...
        Check.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                conn c = new conn();
                try{
                   ResultSet resultSet = c.statement.executeQuery("select * from patients where number = '"+choice.getSelectedItem()+"'");
                   while (resultSet.next()){
